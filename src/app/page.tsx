...
export default function Home() {
  return (
    <div className="flex flex-col justify-evenly items-center h-screen py-10">
      ...
      <div className="flex space-x-20 items-center px-10 py-5 tracking-wide uppercase text-white bg-blue-700">
        <p className={`text-left font-bold text-5xl w-40`}>鉄チン</p>
        <p className={`text-center text-4xl font-extrabold`}>ok</p>
      </div>
